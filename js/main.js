(function ($) {
    ...
    //On Click Open research Block
    $('.research-block, .menu-item.research').on('click', function () {
        $('.content-blocks').removeClass('showx');
        $('.content-blocks.research').addClass('showx');
        $('.menu-item').removeClass('active');
        $('.menu-item.research').addClass('active');
    });
